...
public class Level4GameController : MonoBehaviour
{
    ...
    void SubLevel1()
    {
        ...
        target1.transform.GetChild(0).GetComponent<Level4TargetAction>().audioSource = targetContainer1.GetComponent<AudioSource>();
    ...
    void SubLevel2()
    {
        ...
        target1.transform.GetChild(0).GetComponent<Level4TargetAction>().gameController = this;
        target1.transform.GetChild(0).GetComponent<Level4TargetAction>().audioSource = targetContainer3.GetComponent<AudioSource>();
        TargetMovement tmovement = target1.transform.GetChild(0).GetComponent<TargetMovement>();
        tmovement.SetSpeed(0);
        ...
        target2.transform.GetChild(0).GetComponent<Level4TargetAction>().audioSource = targetContainer2.GetComponent<AudioSource>();
